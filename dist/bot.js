...
export function registerHandlers(bot) {
    ...
    bot.callbackQuery(GAMES.PLINKO.ID, async (ctx) => {
        ...
        await editOrReply(ctx, `<b>💣 Бомбы</b>\n\nДемо доступно в канале. Заказ в боте скоро добавим.`, new InlineKeyboard()
